...
function Navbar() {
  ...
  const cartCount = cartData&&cartData.length;
  ...
  return (
    <div className="navbar-main-container">
      ...
      <div className="navbar-bg">
        ...
        <div
          className={
            navStatus ? "navbar-options nav-options-active" : "navbar-options"
          }
        >
          <Link to="/" style={{ textDecoration: "none" }}>
            <p className="navbar-options-button" onClick={handleNav}>
              Home
            </p>
          </Link>
            ...
            <Link to="/cart">
              <div>
                <ShoppingBasketOutlinedIcon
                  style={{ fontSize: "25px", color: "#394a6e" }}
                />
              </div>
            </Link>
          </div>
